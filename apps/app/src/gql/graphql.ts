...
export type SearchTreatmentOptionsQueryVariables = Exact<{
  searchTerm: Scalars['String']['input'];
}>;

export type SearchTreatmentOptionsQuery = {
  __typename?: 'Query';
  treatmentOptions: Array<{ __typename?: 'TreatmentOption'; name: string; id?: string | null }>;
};
...
export const SearchTreatmentOptionsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'SearchTreatmentOptions' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'treatmentOptions' },
            arguments: [
              {
                kind: 'Argument',
              ...
              selections: [
                {
                  ...
                  name: { kind: 'Name', value: 'medicationId' }
                },
                { kind: 'Field', name: { kind: 'Name', value: 'name' } }
              ]
            }
...
} as unknown as DocumentNode<SearchTreatmentOptionsQuery, SearchTreatmentOptionsQueryVariables>;
