...
import { Box, Button, Container, Flex, HStack, Icon, IconButton, Text } from '@chakra-ui/react';
...
const basePath = 'http://clinical-api.tau.health:4000';
const ory = new FrontendApi(
  new Configuration({
    basePath: 'https://clinical-api.tau.health:40444',
    baseOptions: {
