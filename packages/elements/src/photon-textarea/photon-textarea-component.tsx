        ...
        {props.label ? (
          <div class="flex items-center pb-2 font-sans">
            ...
            <label
              ...
              class="form-control__label text-gray-700 text-sm"
              for="input"
              aria-hidden="false"
            >
              {props.label}
            ...
            {props.required ? (
              <p class="pl-1 text-red-400">*</p>
            ) : (
              <p class="text-gray-400 text-xs pl-2">Optional</p>
            )}
          </div>
        ) : null}
        <sl-textarea
