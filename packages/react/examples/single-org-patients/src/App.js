...
const Login = () => {
  ...
  return (
    <Stack spacing="8">
      <Stack spacing="4" direction="column" justify="space-between" align="start">
...
const PatientTable = () => {
  ...
  return (
    <Stack spacing="8">
      <Stack spacing="4" pt="8" direction="column" justify="space-between" align="start">
      ...
      <Stack spacing="5">
        ...
        <Box overflowX="auto">
          <InfiniteScroll
            ...
            scrollableTarget={document.getElementById('root')?.getElementsByTagName('section')[0]}
            next={async () => {
