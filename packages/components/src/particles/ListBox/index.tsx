...
export default function ListSelect(props: ListSelectProps): JSX.Element {
  ...
  return (
    <Listbox defaultOpen={false} value={selected()} onSelectChange={setSelected} class="relative">
      <ListboxButton class="block text-left w-full rounded-lg border-0 py-3 px-4 shadow-sm ring-1 ring-inset text-sm sm:text-base sm:leading-6 focus:outline-none text-gray-900 ring-gray-300 placeholder:text-gray-400 focus:ring-inset focus:ring-blue-600 focus:ring-2">
